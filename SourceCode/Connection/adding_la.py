...
def adding_la(n1=n1,n2=n2,path_consumer=None,path_source=None ):
    ...
    while( j != n2 ):
        ...
        for i in range(len(source)):
             ...
             if (  consumer_name == source[i][1] and consumer_cod.find(str(source[i][0]))!=-1 ):
                ...
                sheetConsumer.Cells(j,la1_consumer).value = source[i][2]
                sheetConsumer.Cells(j,la2_consumer).value = source[i][3]
                source.pop(i)
                break
        j+=1
